      ...
      <section class=" bg-red-300 relative py-16 text-center">
        ...
        <div class="mt-4 flex-col flex items-center justify-center text-center">
          ...
          <div class="xl:w-1/2 md:w-full mt-8">
            <p class="roboto-medium text-2xl">Thật vui vì được gặp và đón tiếp các bạn trong một dịp đặc
              biệt của gia đình chúng tôi. Chúng tôi muốn gửi đến bạn những lời cảm ơn sâu sắc nhất và để bạn biết chúng tôi rất
      ...
      <section class="flex flex-col items-center justify-center bg-red-300 relative text-white py-8 px-4">
        ...
        <div class="flex flex-col md:flex-row items-center gap-8">
          ...
          <div class="text-center z-20 max-md:order-3">
            ...
            <div class="text-4xl playwrite-gb-s-uniquifier my-8 font-bold mb-2">Thứ 6</div>
            <div class="text-4xl playwrite-gb-s-uniquifier my-8 font-semibold mb-2">15/11/2024</div>
            <div class="my-4 playwrite-gb-s-uniquifier text-lg">(Tức ngày 15.10 năm Giáp Thìn)</div>
            <div class="playwrite-gb-s-uniquifier">Địa điểm tổ chức:</div>
            <div class="text-center playwrite-gb-s-uniquifier text-xl">
              Số 3 Ngõ 33 Thôn Thượng Phúc,<br />
            ...
            <button class="mt-10"><a class="z-50 bg-white text-red-700 font-semibold py-2 px-4 rounded-md"
                                     href="https://maps.app.goo.gl/bwoQPkHms61cjdYx8">Xem bản đồ</a></button>
          </div>
          <!-- Bride section -->
          <div class="text-center">
            <div class="w-80 h-80 rounded-full overflow-hidden mb-4">
